...
| [Images](/docs/vpc-on-classic-vsi?topic=vpc-on-classic-vsi-images) | When you provision {{site.data.keyword.vsi_is_full_notm}}, you can select from the supported stock images or a custom image that you import from {{site.data.keyword.cos_full_notm}}. | [Events that are generated when you manage VPC images](/docs/vpc-on-classic?topic=vpc-on-classic-at-events#events-images) |
...
| [VPN](/docs/vpc?topic=vpc-using-vpn)| Use this service to connect private networks in a secure fashion. You can use VPN to set up an IPsec site-to-site tunnel between your VPC and your on-premise private network or another VPC. | [Events that are generated by the VPN](/docs/vpc?topic=vpc-at-events#events-vpn) |
